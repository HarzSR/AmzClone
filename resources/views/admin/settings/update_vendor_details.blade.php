                        ...
                        <div class="col-xs-12 col-sm-9">
                            <div class="card">
                                ...
                                <div class="body">
                                    ...
                                    <div class="col-md-3">
                                        <label for="email_address">User Type</label>
                                        <div class="form-group">
                                            <div class="form-line">
                                    ...
                                    <div class="col-md-3">
                                        <label for="email_address">Vendor Email</label>
                                        <div class="form-group">
                                            <div class="form-line">
                                    ...
                                    <div class="col-md-3">
                                        <label for="email_address">Vendor Number</label>
                                        <div class="form-group">
                                            <div class="form-line">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            @if(!empty(Auth::guard('admin')->user()->notes))
                                                <div class="btn-group-xs align-right">
                                                    <button type="button" id="deleteVendor" name="deleteVendor"  dataId="notes" dataName="Notes" slug="personal" class="btn bg-red waves-effect m-t-5">Delete</button>
                                                </div>
                                            @endif
                                        </div>
                                    </div>
